...
SECRET_KEY = '^h&40ev7&28%5i9@@n7fnr50t^h+@k)6if+1i8gd1vq@sh#1(g'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'static'),)   #here is where all the static data is gonna save
